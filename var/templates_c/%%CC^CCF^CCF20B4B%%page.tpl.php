<?php /* Smarty version 2.6.18, created on 2013-03-12 15:33:33
...
" class='wiecejNobold' style=''>>|</a>
    ...
    <?php if ($this->_tpl_vars['submit_ascribe'] != ''): ?>
      <input style="color: red;" value="<?php echo $this->_config[0]['vars']['form_back']; ?>
" onclick='location.href="<?php echo $_SERVER['PHP_SELF']; ?>
?<?php echo $this->_tpl_vars['mainParameterName']; ?>
=<?php echo $this->_tpl_vars['mainParameterValue']; ?>
<?php echo $this->_tpl_vars['return']; ?>
"' type="button">
      <input class="form-button" style="color: green;" type="submit" name="<?php echo $this->_tpl_vars['submit_ascribe']; ?>
" value="<?php echo $this->_config[0]['vars']['form_save_button']; ?>
">
    <?php endif; ?>
    </td>
  </tr>
  <tr class='dolna' style='text-align:center;'>
    <td>
      Wyświetla: od <span style='font-weight: bold;'><?php echo $this->_tpl_vars['page']['from']; ?>
</span> do
