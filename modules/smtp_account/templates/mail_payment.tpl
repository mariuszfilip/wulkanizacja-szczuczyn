...
<table width="90%" border="0" style="border-collapse:collapse; font:12px Tahoma, Geneva, sans-serif; color:#3b3b3b; width:90%; margin:0 auto 20px auto;">
  <tr valign="top">
    <td colspan="2" style="padding:4px 0; border-bottom:1px solid #f0f0f0;color:#123969;"><b>Payment success!</b></td>
  </tr>
  ...
  <tr valign="top">
    ...
    <td style="font-weight:bold; padding:4px 0; border-bottom:1px solid #f0f0f0;">{$service.price} $</td>
  </tr>
  
  <tr valign="top">
    <td style="color:#123969; padding:4px 0;  width:22%; border-bottom:1px solid #f0f0f0;"><b>Prepayment:</b></td>
    <td style="color:#d00000; font-weight:bold; padding:4px 0; border-bottom:1px solid #f0f0f0;">{$order.price} $</td>
  </tr>
</table>
