...
class SNSMailer extends PHPMailer {
  ...
  function IsHTML($bool) {
    if($bool == true) {
	  ...
	  if($_SESSION['lang']=='pl') $mailer->AltBody = "Ta wiadomość została wysłana jako HTML. Aby wyświetlić jej treść podejrzyj załączony plik HTML.";
	  else $mailer->AltBody = "This is the body in plain text for non-HTML mail clients.";
    } else {
