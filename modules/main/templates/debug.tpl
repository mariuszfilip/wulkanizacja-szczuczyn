<!-- 
<link rel="stylesheet" href="admin/css/debug.css" media="all" type="text/css" />
<script type="text/javascript" src="admin/js/debug.js"></script>
<div id="debug" style="margin:5px;">
<div class="ajax_debuger_show" style="opacity:.1; cursor: default; right:5px; margin-right:1px;" onclick="{literal} if(undefined===window.ajax_debuger_window) window.open('ajax_debuger.php', 'ajaxFrontDebuger', 'status=0, height=420, width=750, scrollbars=1'); else if(ajax_debuger_window.document) ajax_debuger_window.focus(); else window.open('ajax_debuger.php', 'ajaxDebuger', 'status=0, height=420, width=750, scrollbars=1'); {/literal}">debuger ajaxa</div>
