<?php /* Smarty version 2.6.18, created on 2013-08-20 22:08:17
         compiled from catalog/templates/drag_drop_header.tpl */ ?>
...
<?php if (@CATALOG_DEPTH_LIMIT): ?>
<style>
<?php unset($this->_sections['us1']);
$this->_sections['us1']['name'] = 'us1';
$this->_sections['us1']['start'] = (int)0;
$this->_sections['us1']['loop'] = is_array($_loop=@CATALOG_DEPTH_LIMIT) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
