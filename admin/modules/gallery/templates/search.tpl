...
<table border='0' cellspacing='0' cellpadding='1'>
  <tr class='even' style="height:51px;">
    <td align='left' valign='middle' style='width:45%; padding-left:15px;'>
      <b>Nazwa</b><br>
      <input type='text' size='20' name='s_{$mainParameterValue}[name]' value='{$s_gallery.name|escape|stripslashes}' class='form-text'>
    </td>
