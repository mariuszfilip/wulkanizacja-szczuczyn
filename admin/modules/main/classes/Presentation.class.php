...
class Presentation extends Smarty implements IPresentation {
  ...
  protected $mainTpl = 'main/templates/index.tpl';

  public function __construct() {
    $this->Smarty();
    $this->template_dir      = ADMIN_DIR . 'modules/';
    $this->compile_dir       = ADMIN_DIR . 'var/templates_c/';
  ...
  public function setTemplateDir($dir) {
  	$this->template_dir = ADMIN_DIR . $dir;
  }

  public function setCompileDir($dir) {
  	$this->compile_dir = ADMIN_DIR . $dir;
  }
}
